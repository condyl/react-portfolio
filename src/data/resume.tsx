...
export const DATA = {
  ...
  summary: "I'm a [2nd year Computer Science student at Brock University](#education).  I've completed some cool projects like a [3D interactive math game](https://www.cariboutests.com/games/packing.php) and a [web interface for a mathematical knots program](https://www.cariboutests.com/games/knots).  I'm currently working on a [course planner](https://www.brocktimetable.com) for Brock University students.  If I'm not coding, I'm probably rock climbing.",
  avatarUrl: "/me.webp",
  skills: [
    "Java",
    "Python",
